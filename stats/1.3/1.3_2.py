...
# over 20 rounds, greedy won 80% of the time
...
def play_single_round(round_index):
    ...
    while True:
        ...
        board, nodes, piece = Agent(boardmatrix=current_board, turn=2, depth=5, function=2, is_alpha_beta=True, type=0).decision()
